...
var data=[
    {title:"What is DOM",img:"img/1.jpg",choices:["Document Oriented Machine","Document Object Model","Divide Object Model"],answer:"Document Object Model"},
    {title:"Inside which HTML element do we put the JavaScript?",img:"img/2.jpg",choices:["<js>","<script>","<java>"],answer:"<script>"},
    {title:"What should appear at the very end of your JavaScript?",img:"img/3.jpg",choices:["The </script>","</>","none"],answer:"The </script>"}
];
